...
+ Кнопка "Поиск" для перехода на страницу с результатом поиска;
...
- Главная страница, содержащая список книг, где каждое название книги - ссылка на страницу с информацией о книге;
- Страница регистрации, содержащая форму для регистрации;
- Страница входа, содержащая форму для авторизации.

#### Другие страницы: 
- Страницы с информацией о книгах, доступные по ссылкам, находящимися на главной странице.


## Для авторизованных пользователей
### Главное меню:
+ Кнопка "Главная" для перехода на главную страницу;
+ Кнопка "Поиск" для перехода на страницу поиска;
...
+ Поиск книг:
+ + кнопка "Поиск" главного меню -> страница поиска
